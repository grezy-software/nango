...
export const TweetHeader = ({ tweet }: { tweet: EnrichedTweet }) => (
  <div className="flex flex-row justify-between tracking-tight">
    ...
    <a href={tweet.url} target="_blank" rel="noreferrer">
      ...
      <Icons.x className="size-5 items-start transition-all ease-in-out hover:scale-105" />
    </a>
  </div>
)
        ...
        case "mention":
          return (
            <a
              ...
              className="text-sm font-normal text-[#1DA1F2] transition-all duration-75 hover:underline"
            >
