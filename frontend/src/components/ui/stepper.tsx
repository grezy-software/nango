...
const verticalStepVariants = cva(
  "relative flex flex-col transition-all duration-200",
  {
    variants: {
      variant: {
        circle: cn(
          "gap-[var(--step-gap)] pb-[var(--step-gap)]",
    ...
    return (
      <div
        ...
        className={cn(
          ...
          "data-[completed=true]:[&:not(:last-child)]:after:bg-[#FF3131]",
      ...
      >
        <div
          ...
          className={cn(
            ...
            "flex items-center",
            variant === "line" &&
              "border-s-[3px] py-2 ps-3 data-[active=true]:border-[#FF3131]",
    ...
    return (
      <div
        ...
        className={cn(
          ...
          variant === "line" &&
            "flex-1 flex-col border-t-[3px] data-[active=true]:border-[#FF3131]",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "data-[active=true]:text-primary-foreground dark:data-[active=true]:text-primary data-[active=true]:border-[#FF3131] data-[active=true]:bg-[#FF3131]",
        "data-[current=true]:bg-secondary data-[current=true]:border-[#FF3131]",
...
const StepLabel = ({
  ...
  return shouldRender ? (
    <div
      aria-current={isCurrentStep ? "step" : undefined}
      className={cn(
        "stepper__step-label-container cursor-pointer",
        "flex flex-col",
